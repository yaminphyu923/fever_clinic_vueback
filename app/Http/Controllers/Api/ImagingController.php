...
class ImagingController extends Controller
{
    ...
    public function imagingUpdate(Request $request){
        $image = $request->all();
        ...
        $old_data->patient_id = $request->patient_id;
        $old_data->doctor_id = $request->doctor_id;
        $old_data->date_requested = $request->date_requested;
        $old_data->date_analysis = $request->date_analysis;
        $old_data->analysis = $request->analysis;
        $old_data->conclusion = $request->conclusion;
        $old_data->user_id = $request->user_id;
        $old_data->save();
    ...
    public function detailImagingPrint($patient_id){
        $imagings = Imaging::with('patient','doctor')
                            ->where('patient_id',$patient_id)
                            ->latest('id')->get();
        return ApiResponse::success('successful',$imagings);
    }
}
