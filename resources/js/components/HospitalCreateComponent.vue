                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <Select2 v-model="hospitals.bed_id" :options="beds" :settings="{ settingOption: beds.text, settingOption: beds.text,settingOption: beds.room, settingOption: beds.room }"/>
