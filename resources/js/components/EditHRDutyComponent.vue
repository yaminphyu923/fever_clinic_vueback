            ...
            <div class="col-sm-12">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <h4 class="text-center my-4">Edit HR duty</h4>
                        ...
                        <form @submit.prevent="update">
                            ...
                            <div class="text-right">
                                <a href="/hrDuty"><button type="button" class="btn btn-danger">Back</button></a>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            edit(){
                axios.get(`/api/hr_duties/${this.id}`)
                .then(response => {
            ...
            update(){
                ...
                axios.put(`/api/hr_duties/${this.id}`,this.hr_duties)
                .then(response => {
                    this.edit();
                    Toast.fire({
                        icon: 'success',
