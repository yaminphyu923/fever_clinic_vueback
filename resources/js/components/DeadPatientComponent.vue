    ...
    <div class="container-fluid mt-5">
        <div class="row justify-content-center">
            ...
            <div class="col-sm-12 d-flex justify-content-end">
                ...
                <a href="/deadpatient-export"><button class="btn btn-md btn-primary mr-1">📃 Export Excel</button></a>
...
<script>
    export default {
        ...
        methods: {
            ...
            index(page=1){
                axios.get(`/api/deadPatientPaginate?page=${page}&search=${this.search}&startDate=${this.date.start_date}&endDate=${this.date.end_date}`)
                .then(response => {
