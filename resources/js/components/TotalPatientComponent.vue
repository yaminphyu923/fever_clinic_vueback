    ...
    <div class="container-fluid mt-5">
        <div class="row justify-content-center">
            <div class="col-sm-10 offset-sm-1">
                <h3><b>Total Patient Lists</b></h3>
            </div>

            <div class="col-sm-12 d-flex justify-content-end">
                <button class="btn btn-md btn-primary mr-1" data-toggle="modal" data-target="#addExcel">📃 Import Excel</button>
                <a href="/totalpatient-export"><button class="btn btn-md btn-primary mr-1">📃 Export Excel</button></a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Adding Total Patient Excel File</h5>
...
<script>
    export default {
        ...
        methods: {
            ...
            index(page=1){
                axios.get(`/api/patients_paginate?page=${page}&search=${this.search}&startDate=${this.date.start_date}&endDate=${this.date.end_date}`)
                .then(response => {
