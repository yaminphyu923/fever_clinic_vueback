            ...
            <div class="card register-card my-5">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('homeRegister') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 offset-md-1 col-form-label text-md-right">{{ __('Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="sama" class="col-md-4 offset-md-1 col-form-label text-md-right">SAMA</label>

                            <div class="col-md-6">
                                <input id="sama" type="text" class="form-control @error('sama') is-invalid @enderror" name="sama" value="{{ old('sama') }}" autocomplete="sama" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 offset-md-1 col-form-label text-md-right">{{ __('Confirm Password') }}</label>
